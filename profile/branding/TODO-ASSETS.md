# Bekaros branding TODO (assets not ready)

Drop-in replacements for v01 placeholders — no code refactor needed when ready:

- `profile/syslinux/splash.png` (640x480 PNG, replace stock Arch)
